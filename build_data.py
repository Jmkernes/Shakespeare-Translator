...
flags.DEFINE_integer('input_vocab_size', default=16000, help='Input vocab size. This flag is ignored if train_inp_tokenizer=False')
flags.DEFINE_integer('target_vocab_size', default=16000, help='Target vocab size. This flag is ignored if train_tar_tokenizer=False')
